...
# https://curlconverter.com/python/ helps extracting this info
# On Chrome, press F12 to open DevTools, go to the Network tab,
# reload the web page and search by "Bearer" to find the token.
